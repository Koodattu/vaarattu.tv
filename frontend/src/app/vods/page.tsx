  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="mb-8">
        ...
        <p className="text-gray-400">Browse all past streams and their viewer timelines</p>
      </div>
      ...
      <div className="bg-gray-800 rounded-lg p-12 text-center">
        ...
        <p className="text-gray-400 mb-6">The VODs page is under construction. Check back soon!</p>
